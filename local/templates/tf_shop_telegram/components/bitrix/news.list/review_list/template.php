...
<div class="review-list row" data-masonry='{"percentPosition": true }'>
    <?php
            ...
            <header class="review-item__header">
                ...
                <div class="review-item__header-wrapper">
                    ...
                    <div class="review-item__rating">
                        <?php for ($i = 1; $i <= 5; $i++): ?>
                        <i class="fa-<?= ($i <= $arItem['DISPLAY_PROPERTIES']['ATT_RATING']['VALUE']) ? 'solid': 'regular' ?> fa-star review-item__rating-icon"></i>
                        <?php endfor; ?>
                        <div class="review-item__rating-text">
